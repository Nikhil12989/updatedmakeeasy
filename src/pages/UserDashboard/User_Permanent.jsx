...
const User_Permanent = () => {
  ...
  useEffect(() => {
    const fetchLicenseData = async () => {
      try {
        ...
        const response = await axios.get(
          `http://192.168.1.50:5000/api/permanentLicense/getPermanentDL/${id}`
        );
    ...
    learningLicenseNumber:data.learningLicenseNumber || ""
  ...
  const handleUpdate = async (event) => {
    ...
    try {
      const response = await axios.put(
        `http://192.168.1.50:5000/api/permanentLicense/updatePermanentLicense/${id}`,
        formData,
        {
          headers: {
        ...
        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
          <div className="px-4 py-5 sm:p-6">
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
              ...
              <div>
                <label className={labelClass} htmlFor="learningLicenseNumber">
                learningLicenseNumber
                </label>
                <input
                  ...
                  type="text"
                  className={inputClass}
                  value={licenseData.learningLicenseNumber}
                  onChange={handleInputChange}
                  required
                />
              </div>
          ...
          {licenseData.Status === "Rejected" && (
            <div>
              ...
              <div>
                <label className={labelClass} htmlFor="learningLicense">
                learning License
                </label>
                <input
                  id="learning License"
