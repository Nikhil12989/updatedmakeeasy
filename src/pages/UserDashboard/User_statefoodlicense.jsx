      ...
      const fetchLicenseData = async () => {
        try {
          ...
          const response = await axios.get(
            `http://192.168.1.50:5000/api/stateFoodLicense/getStateFoodLicense/${id}`
          );
    ...
    const handleUpdate = async (event) => {
      ...
      try {
        const response = await axios.put(
          `http://192.168.1.50:5000/api/stateFoodLicense/updatestatefoodlicense/${id}`,
          formData,
...
export default User_statefoodlicense;
