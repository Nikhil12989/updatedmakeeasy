...
import { IoArrowBackCircle } from 'react-icons/io5'; // Import the IoArrowBackCircle icon
 ...
 const handleSubmit = async (e) => {
  ...
  if (!auth.token) {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/localFoodLicense/createLocalFoodLicense', form, {
        headers: {
  ...
  return (
    <div>
      ...
      <div className="page-title py-6 bg-slate-300 flex items-center mb-4" data-aos="fade">
        <div className="container mx-auto px-4 lg:px-20 flex flex-col lg:flex-row justify-between items-start lg:items-center">
          {/* Title */}
          <h1 className=" text-black text-xl md:text-2xl font-semibold">Local Food License / Registration </h1>
    ...
    `}</style>
      ...
      <div>
        <h2 className="text-green-600 text-center font-semibold text-2xl pt-8 sm:mt-0">- Local Food License / Registration -</h2>
      </div>
      <form
