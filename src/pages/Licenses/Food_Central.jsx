...
const Food_Central = () => {
  ...
  if (!auth.token) {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/centralFoodLicense/createCentralFoodLicense', form, {
        headers: {
  ...
  return (
    <div>
      ...
      <div className="page-title py-6 bg-slate-300" data-aos="fade">
        <div className="container mx-auto px-4 lg:px-20 flex flex-col lg:flex-row justify-between items-start lg:items-center">
          {/* Title */}
          <h1 className=" text-black text-xl md:text-2xl font-semibold">Central  Food License/Registration</h1>
    ...
    `}</style>
      ...
      <div>
        <h2 className="text-green-600 text-center font-semibold text-2xl pt-8 sm:mt-0">- Central  Food License / Registration -</h2>
      </div>
      <form
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="form-group">
            <label htmlFor="licenseRequireYears" className="block text-gray-600 font-semibold mb-2">Select License Require Years</label>
            <select
              ...
              required
            >
              <option value="" disabled>Select License Require Years</option>
