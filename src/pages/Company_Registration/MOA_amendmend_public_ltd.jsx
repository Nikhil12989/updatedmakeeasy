...
const MOA_amendmend_public_ltd = () => {
    ...
    <div>
      ...
      <div className="page-title py-6 bg-slate-300" data-aos="fade">
        <div className="container mx-auto px-4 lg:px-20 flex flex-col lg:flex-row justify-between items-start lg:items-center">
          {/* Title */}
          <h1 className=" text-black text-xl md:text-2xl font-semibold">MOA Amendmend of Public Ltd
      ...
      <div className="container mx-auto px-4 lg:px-16 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            What is the Moa for a Public Limited Company?
            </h1>

            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p>The Memorandum of Association, Moa, is an important document of a Public Limited Company in certain Jurisdictions. It shows the company’s initial capital and the ‘object clause’ which lets the shareholders, creditors, and those dealing with the Public Limited Company know about what is the limit of range of operation .</p>
              <p>It contains the Article of Association (AOA) as the company’s internal constitution for regulating the business operation and at the time of incorporation, the memorandum is mandatory to be filed with the Registrar.</p>

              <h1 className="text-xl font-semibold mb-4 mt-3">What is the Moa Amendment Procedure?</h1>
              <p>Due to several reasons, a Limited Company’s Memorandum of Association can be modified or amended. In the process, the concerned organization is required to follow the provisions of the Companies Act, 2013 and the guidelines of the Registrar of Companies ROC.</p>
...
export default MOA_amendmend_public_ltd
