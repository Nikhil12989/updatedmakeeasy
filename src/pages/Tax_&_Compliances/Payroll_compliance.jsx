  ...
  return (
    ...
    <div className="page-title py-6 bg-slate-300" data-aos="fade">
      <div className="container mx-auto px-4 lg:px-20 flex flex-col lg:flex-row justify-between items-start lg:items-center">
        {/* Title */}
        <h1 className=" text-black text-xl md:text-2xl font-semibold">PF ESIC Registration</h1>
  ...
  `}</style>
    ...
    <div className="container mx-auto px-4 lg:px-16 py-8">
      <div className="text-center mb-8">
        ...
        <h3 className='pt-4 text-base font-semibold'>One-Stop Solutions for PF ESIC Registration Online! 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        {/* Right side - Content */}
        <div>
          <p className='pt-6 mb-4 text-2xl font-semibold'>
          Employee PF & ESIC Registration for Your Company          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h3 className="text-lg font-semibold text-orange-600 mb-2 text-center">
              Our Qualified CA/CS Will Help You Register Employee PF and ESIC Flawlessly and Quickly
              </h3>

              <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 list-inside text-gray-600 mt-2">
                <li>✔ 10 Years+ experienced CA/CS</li>
                <li>✔ 1 Lakh+ Satisfied Clients</li>
                <li>✔ Guaranteed Quality Services</li>
                <li>✔ ISO 9001:2015 Certified</li>
                <li>✔ Challenging Low Cost Across India</li>
...
export default Payroll_compliance
