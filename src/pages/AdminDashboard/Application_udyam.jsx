...
const Application_udyam = () => {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto bg-gray-50 rounded-lg shadow-lg">
      <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-8">Udyam License Application</h1>

      {/* License Data */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
        <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
          <h2 className="text-lg font-semibold mb-4 text-gray-700 border-b pb-2">Business Information</h2>
          <p className="text-gray-800"><strong className="text-gray-600">Business Name:</strong> {licenseData.businessName}</p>
          <p className="text-gray-800"><strong className="text-gray-600">Business Start Date:</strong> {new Date(licenseData.businessStartDate).toLocaleDateString()}</p>
          <p className="text-gray-800"><strong className="text-gray-600">Number of Employees:</strong> {licenseData.numberOfEmployees}</p>
          <p className="text-gray-800"><strong className="text-gray-600">Nature of Business:</strong> {licenseData.natureOfBusiness}</p>
          <p className="text-gray-800"><strong className="text-gray-600">Business Investment:</strong> {licenseData.bussinessInvestment}</p>
        </div>

        <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
          <h2 className="text-lg font-semibold mb-4 text-gray-700 border-b pb-2">Personal Information</h2>
          <p className="text-gray-800"><strong className="text-gray-600">Full Name:</strong> {licenseData.ownerFullName}</p>
          <p className="text-gray-800"><strong className="text-gray-600">Gender:</strong> {licenseData.gender}</p>
          <p className="text-gray-800"><strong className="text-gray-600">Pan Card Number:</strong> {licenseData.PanCardNumber}</p>
          <p className="text-gray-800"><strong className="text-gray-600">Aadhar Card Number:</strong> {licenseData.AadharCardNumber}</p>
        </div>
      </div>
...
export default Application_udyam;
