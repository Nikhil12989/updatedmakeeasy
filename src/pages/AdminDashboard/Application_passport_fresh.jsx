...
const Application_passport_fresh = () => {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchLicenseData = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/api/freshPassport/getbyidfresh-passport/${id}`);
    ...
    const handleUpdate = async (event) => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:5000/api/freshPassport/updatefresh-passport/${id}`,
                formData,
                {
                    headers: {
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto bg-gray-50 rounded-lg shadow-lg">
            <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-8">Application Passport Fresh</h1>
            {/* License Data */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">Aadhar Number:</strong> {licenseData.aadharNumber}</p>
                ...
                <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">Permanent Address:</strong> {licenseData.permanentAddress}</p>
                    <p className="text-gray-800"><strong className="text-gray-600">Education Qualification:</strong> {licenseData.educationQualification}</p>
...
export default Application_passport_fresh;
