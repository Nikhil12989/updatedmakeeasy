        ...
        <section class="max-w-4xl p-6 mb-12 mt-24 mx-auto bg-gradient-to-r from-blue-500 to-blue-800 rounded-md shadow-xl dark:bg-gray-800">
          <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              <div>
                <label class="text-white font-semibold text-xl dark:text-gray-200" for="name"> Name <span class="text-red-500 ml-1">*</span></label>
              ...
              <div>
                <label class="text-white font-semibold text-xl dark:text-gray-200" for="photo">Photo </label>
                <input id="photo" type="file" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
              </div>

              <div>
                <label class="text-white font-semibold text-xl dark:text-gray-200" for="designation"> Designation <span class="text-red-500 ml-1">*</span></label>
                <input id="designation" type="text" placeholder='Enter Designation...' class="block w-full px-4 py-2 mt-2 
                             text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300
                              dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 
                              focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" required />
              </div>
              <div>
                <label class="text-white font-semibold text-xl dark:text-gray-200" for="description"> Description </label>
                <input id="description" type="text" placeholder='Enter Description...' class="block w-full px-4 py-2 mt-2 
                             text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300
                              dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 
