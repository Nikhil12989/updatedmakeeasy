...
const Application_passport_reissue = () => {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchLicenseData = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/api/reIssuePassport/getbyidre-issue-passport/${id}`);
    ...
    const handleUpdate = async (event) => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:5000/api/reIssuePassport/updatere-issue-passport/${id}`,
                formData,
                {
                    headers: {
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto bg-gray-50 rounded-lg shadow-lg">
            <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-8">Application passport re-issue</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">Old Passport Number:</strong> {licenseData.oldPassportNumber}</p>
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">Place of Birth:</strong> {licenseData.placeOfBirth}</p>
                    <p className="text-gray-800"><strong className="text-gray-600">Marital Status:</strong> {licenseData.maritalStatus}</p>
                </div>
                ...
                <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">Present Address:</strong> {licenseData.presentAddress}</p>
                    <p className="text-gray-800"><strong className="text-gray-600">Permanent Address:</strong> {licenseData.permanentAddress || 'N/A'}</p>
                    <p className="text-gray-800"><strong className="text-gray-600">Emergency Contact:</strong> {licenseData.emergencyContactFullName} ({licenseData.emergencyContactNumber})</p>
                </div>
            </div>
...
export default Application_passport_reissue;
