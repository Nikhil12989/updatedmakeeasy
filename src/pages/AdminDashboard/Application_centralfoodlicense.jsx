...
const Application_centralfoodlicense = () => {
    const { id } = useParams();
    ...
    return (
      <div className="p-8 max-w-5xl mx-auto bg-gray-50 rounded-lg shadow-lg">
        <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-8">Central food license Application</h1>
...
export default Application_centralfoodlicense
