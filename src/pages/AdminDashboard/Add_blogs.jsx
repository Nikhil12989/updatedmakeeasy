...
const Add_blogs = () => {
  return (
    <div className='flex1'>
      ...
      >
        <section class="max-w-4xl mb-12 p-6 mt-24 mx-auto bg-gradient-to-r from-blue-500 to-blue-800 rounded-md shadow-xl dark:bg-gray-800 transition-transform duration-300">
          <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              <div>
                <label class="text-white font-semibold text-xl dark:text-gray-200" for="blogtitle">
                  Blog Title<span class="text-red-500 ml-1">*</span>
                </label>
                <input id="blogtitle" type="text" placeholder='Enter Blog Title...' class="block w-full px-4 py-2 mt-2 
     text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300
      ...
      focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" required />
              ...
              <div>
                <label class="text-white font-semibold text-xl dark:text-gray-200" for="blogimg">Image<span class="text-red-500 ml-1">*</span></label>
                <input id="blogimg" type="file" placeholder='' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" required />
              </div>


              <div>
                <label class="text-white font-semibold text-xl dark:text-gray-200" for="date">Date<span class="text-red-500 ml-1">*</span></label>
              ...
              <div>
                ...
                <textarea id="description" placeholder='Enter Blog Description...' class="block w-full px-4 py-2 mt-2 
     text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300
      dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 
