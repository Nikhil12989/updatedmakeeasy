...
const Application_gstregistration = () => {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchLicenseData = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/api/gstRegistration/getbyidgst-registration/${id}`);
    ...
    const handleUpdate = async (event) => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:5000/api/gstRegistration//updategst-registration/${id}`,
                formData,
                {
                    headers: {
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto bg-gray-50 rounded-lg shadow-lg">
            <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-8">GST Registration Application</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">Business Full Name:</strong> {licenseData.businessFullName}</p>
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">PAN Number:</strong> {licenseData.panNumber}</p>
                ...
                <div className="bg-white shadow-md p-6 rounded-lg space-y-4">
                    ...
                    <p className="text-gray-800"><strong className="text-gray-600">Rejected Note:</strong> {licenseData.rejectedNote}</p>
                </div>
            </div>
...
export default Application_gstregistration;
